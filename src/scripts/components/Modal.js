...
export default class Modal {
  ...
  updateContent(data) {
    ...
    if (this.modalId == 'tpl-modal') {
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { text: this.element.dataset.modalText }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { plate: this.element.dataset.modalPlate }
      );
      ...
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { subtitle: this.element.dataset.modalSubtitle }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { telephone: this.element.dataset.modalTelephone }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { courriel: this.element.dataset.modalCourriel }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { adresse: this.element.dataset.modalAdresse }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { ville: this.element.dataset.modalVille }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { postal: this.element.dataset.modalPostal }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { allday: this.element.dataset.modalAllday }
      );
      this.modalElement.innerHTML = Utils.parseTemplate(
        this.modalElement.innerHTML,
        { heure1: this.element.dataset.modalHeure1 }
      );
    }
  }
